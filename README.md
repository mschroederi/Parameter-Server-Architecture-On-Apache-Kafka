...
As one can see in the plot above, the model trained with an event frequency of 10 tuples per worker was able to reach f1 sores of ~0.45 which is very close to performance of the above mentioned ground trough algorithm which reached a f1 score 0.47 on the test data.
